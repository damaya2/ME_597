...
DATASET_PATH = "crtbp_llm_dataset_20260818_170053.jsonl"
OUTPUT_DIR = "./results_llama3_1_8b_crtbp_fast_v6"
...
def main():
    ...
    sft_config = SFTConfig(
        ...
        # FIX FOR DDP RE-ENTRANT BACKWARD PASS ISSUE:
    ...
    if RESUME_TRAINING:
        checkpoint_to_resume = os.path.join(OUTPUT_DIR, "checkpoint-1000")
